...
import { salsaVenues } from '@/data/nightlifeData';
...
const SalsaClubsSection = () => {
  return (
    <section>
      ...
      <p className="text-lg text-center text-gray-700 max-w-3xl mx-auto mb-12">{salsaVenues.description}</p>
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        {salsaVenues.venues.map(venue => (
