...
export interface Sight {
  id: string;
  name: string;
  category: 'Museum' | 'Landmark' | 'Park' | 'Palace' | 'Square' | 'Viewpoint' | 'Garden';
...
export const sights: Sight[] = [
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1560421027-761784610427?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80',
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1590155109069-041279810591?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80',
